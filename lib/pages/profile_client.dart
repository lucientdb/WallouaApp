      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            ...
            child: const Text(
              'Déconnexion',
              style: TextStyle(color: Color.fromARGB(255, 174, 24, 14)),
            ),
          ),
        ],
      ),
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    OutlinedButton.icon(
                      onPressed: _logout,
                      icon: const Icon(Icons.logout, color: Color.fromARGB(255, 184, 26, 14)),
                      label: const Text(
                        'Se déconnecter',
                        style: TextStyle(color: Color.fromARGB(255, 184, 26, 14)),
                      ),
                      style: OutlinedButton.styleFrom(
                        padding: const EdgeInsets.symmetric(vertical: 15),
                        shape: RoundedRectangleBorder(
                        ...
                        side: const BorderSide(color: Color.fromARGB(255, 184, 26, 14)),
                      ),
                    ),
                  ],
                ),
